SAMMI.extCommand('Sando: Read Folder', 4467268, 52, {
    ...
    'sort': ['Sort By...', 19, 'Default', null, ['Default', 'Date (Newest)', 'Date (Oldest)','Size (Smallest)','Size (Largest)']],
  }, true);
SAMMI.extCommand('Sando: Extract Zip', 4467268, 52, {
...
SAMMI.extCommand('Sando: Get Process Path', 4467268, 52, {
    save_variable: ['Status Variable', 14, '', 0.6, null],
    process_name: ['Process Name', 14, '', 1.4, null],
  }, true);
SAMMI.extCommand('Sando: Powershell', 4467268, 80, {
...
SAMMI.extCommand('Sando: Set Deck Buttons Variables', 4467268, 52, {
...
SAMMI.extCommand('Sando: File Watch/Tail', 4467268, 52, {
  ext_trigger: ['Extension Trigger', 14, '', null, null],
  path: ['File Path', 22, '', null, null],
  list_type: ['List Type (if needed)', 19, 'Whitelist', null, ['Whitelist', 'Blacklist']],
  list: ['Stringified Array of Matches', 15, '', null, null]
}, true);
SAMMI.extCommand('Sando: Scene Packer', 7873596, 52, {
    mode: ['Mode', 25, 'Choose Mode...', null, ['Sando: SP Unpack', 'Sando: SP Pack']]
}, true)
SAMMI.extCommand('Sando: SP Unpack', 7873596, 52, {
    mode: ['Mode', 25, 'Sando: SP Unpack', null, ['Sando: SP Unpack', 'Sando: SP Pack']],
    spkg: ['.spkg Path', 22, '', null, null],
    status: ['Save Status Variable', 14, '', null, null]
}, true, true)
SAMMI.extCommand('Sando: SP Pack', 7873596, 52, {
    mode: ['Mode', 25, 'Sando: SP Pack', null, ['Sando: SP Unpack', 'Sando: SP Pack']],
...
SAMMI.extCommand('Sando: Array Search (Simple)', 7873596, 52, {
    mode: ['Mode', 25, 'Sando: Array Search (Simple)', null, ['Sando: Array Search (Simple)']],
...
SAMMI.extCommand('Sando: Extract .sef Assets', 4467268, 80, {
    extName: ['Extension Name', 14, '', null, null],
    var: ['Status Variable', 14, '', null, null]
  }, true);
SAMMI.extCommand('Sando: Extract .sef Assets (No Node)', 4467268, 80, {
    extName: ['Extension Name', 14, '', null, null],
    var: ['Status Variable', 14, '', null, null]
  }, true, true);
...
//   }, true);
SAMMI.extCommand('Sando: Twitch Get User Info (Cached)', 4467268, 80, {
